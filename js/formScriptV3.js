        ...
        const y = async (event) => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    f.classList.remove("d-none"); // Show success message or any elements related to successful submission
                    E.forEach((t => {
                        t.setAttribute("disabled", ""); // Disable form fields after successful submission
                    }));
                } else {
                    // Handle errors or unsuccessful form submission
                    console.error('Form submission failed');
                    v.classList.remove("d-none"); // Show error message or any elements related to failed submission
                }
            } catch (error) {
